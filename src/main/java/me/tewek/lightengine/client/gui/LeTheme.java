...
public final class LeTheme {
    ...
    public static void frame(GuiGraphics graphics, int x, int y, int w, int h, int bg, int border) {
    ...
    public static void centeredText(GuiGraphics graphics, String text, int x, int y, int w, int color) {
        graphics.drawCenteredString(Minecraft.getInstance().font, text, x + w / 2, y, color);
    }
}
