...
public class LeIconButton extends LeButton {
    ...
    public static void drawGear(GuiGraphics graphics, int x, int y, int s) {
        int c = LeTheme.TEXT;
    ...
    public static void drawCross(GuiGraphics graphics, int x, int y, int s) {
        int c = LeTheme.TEXT;
        for (int i = 0; i < 8; i++) {
    ...
    public static void drawChevronUp(GuiGraphics graphics, int x, int y, int s) {
        int cx = x + s / 2;
        int c = LeTheme.TEXT;
    ...
    public static void drawChevronDown(GuiGraphics graphics, int x, int y, int s) {
        int cx = x + s / 2;
        int c = LeTheme.TEXT;
    ...
    public static void drawDownload(GuiGraphics graphics, int x, int y, int s) {
        int cx = x + s / 2;
        int c = LeTheme.TEXT;
    ...
    public static void renderTooltip(GuiGraphics graphics, Font font, int mouseX, int mouseY,
        ...
        graphics.drawString(font, raw, tx + 5, ty + 5, LeTheme.TEXT);
